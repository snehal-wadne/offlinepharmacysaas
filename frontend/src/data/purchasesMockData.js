...
export const MOCK_PURCHASE_ORDERS_LIST = [
  {
    ...
    customerPhone: '+91 98220 11450',
    prescriptionRef: 'Rx-2026-4412',
    createdBy: 'Manager',
  },
  {
    id: 'PO-1025',
  ...
  },
  {
    ...
    amount: '₹15,800.00',
    numericAmount: 15800.00,
    itemsCount: 8,
    status: 'Pending',
    branch: 'Main Branch',
    medicine: 'Metformin 500mg (Box of 200)',
    isCustomerOrder: false,
    createdBy: 'Manager',
  },
  {
    ...
    amount: '₹6,400.00',
    numericAmount: 6400.00,
    itemsCount: 2,
    status: 'Received',
    branch: 'East Clinic',
    medicine: 'Amoxicillin 250mg Syrup',
    isCustomerOrder: false,
    createdBy: 'Admin',
  },
  {
