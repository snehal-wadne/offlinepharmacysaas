  ...
  return (
    ...
    >
      ...
      <View style={[styles.headerRow, isMobile && styles.headerRowMobile]}>
        <View style={styles.titleWrapper}>
          ...
          <Text style={styles.pageSubtitle}>
            View customer profile, purchase history, returns and ledger (if enabled).
          </Text>
        </View>
      ...
      <View style={styles.profileCard}>
        <View style={[styles.profileCardBody, isCompact && styles.profileCardBodyCompact]}>
          ...
          <View style={[styles.profileStatsRow, isMobile && styles.profileStatsRowMobile]}>
            ...
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValueBold}>{profile.customerSince || '15 Feb 2023'}</Text>
            </View>
            ...
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValueBold}>{profile.totalPurchasesCount || `${profile.totalInvoices || 12} Orders`}</Text>
            </View>
            ...
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValueOrange}>{profile.outstandingBalance || '₹250.00'}</Text>
            </View>
            ...
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValueBold}>{profile.creditLimit || '₹2,000.00'}</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View style={styles.tabsContainer}>
        ...
        >
          ...
          >
            ...
            {activeTab === 'purchases' && <View style={styles.activeTabIndicator} />}
          </Pressable>
          ...
          >
            ...
            {activeTab === 'returns' && <View style={styles.activeTabIndicator} />}
          </Pressable>
          ...
          >
            ...
            {activeTab === 'ledger' && <View style={styles.activeTabIndicator} />}
          </Pressable>
      ...
      {activeTab === 'purchases' && (
        <View style={[styles.splitGridRow, isCompact && styles.splitGridRowStacked]}>
          {/* Main Card: Invoices Table */}
          <View style={[styles.mainTableCol, isCompact && styles.mainTableColFull]}>
            <View style={styles.cardContainer}>
              ...
              <View style={[styles.cardHeaderRow, isMobile && styles.cardHeaderRowMobile]}>
                <View style={styles.cardTitleBox}>
                  ...
                  <Text style={styles.cardSubtitle}>All invoices for this customer.</Text>
                </View>

                <View style={[styles.searchBoxWrapper, isMobile && styles.searchBoxWrapperMobile]}>
              ...
              <View style={[styles.paginationFooter, isMobile && styles.paginationFooterMobile]}>
                ...
                <View style={styles.paginationControls}>
                  ...
                  >
                    <Text style={[styles.pageNavBtnText, currentPage === 1 && styles.pageNavBtnTextDisabled]}>‹</Text>
                  </Pressable>
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((pg) => (
                    <Pressable
                      ...
                      style={[styles.pageNumberBtn, currentPage === pg && styles.pageNumberBtnActive]}
                    >
                      <Text
                        style={[
                  ...
                  >
                    <Text style={[styles.pageNavBtnText, currentPage === totalPages && styles.pageNavBtnTextDisabled]}>›</Text>
                  </Pressable>
                </View>
              </View>
            </View>
          ...
          <View style={[styles.sideSummaryCol, isCompact && styles.sideSummaryColFull]}>
            <View style={styles.summaryCard}>
              <Text style={styles.summaryCardTitle}>Summary</Text>

              <View style={styles.summaryItem}>
                <Text style={styles.summaryItemLabel}>TOTAL INVOICES</Text>
                <Text style={styles.summaryItemValueBold}>{profile.totalInvoices || invoices.length}</Text>
              </View>
              ...
              <View style={styles.summaryItem}>
                ...
                <Text style={styles.summaryItemValueBold}>{profile.totalSpent || '₹2,880.00'}</Text>
              </View>
              ...
              <View style={styles.summaryItem}>
                ...
                <Text style={styles.summaryItemValueBold}>{profile.totalReturns || '₹210.00'}</Text>
              </View>

              <View style={styles.summaryDivider} />

              <View style={styles.summaryItem}>
                <Text style={styles.summaryItemLabelOrange}>OUTSTANDING BALANCE</Text>
                <Text style={styles.summaryItemValueOrange}>{profile.outstandingBalance || '₹250.00'}</Text>
              </View>
        ...
        <View style={styles.cardContainer}>
          <View style={styles.cardHeaderRow}>
            <View style={styles.cardTitleBox}>
              ...
              <Text style={styles.cardSubtitle}>Processed items and refunds returned by this customer.</Text>
            </View>
          </View>
          ...
          <View style={[styles.cardHeaderRow, isMobile && styles.cardHeaderRowMobile]}>
            <View style={styles.cardTitleBox}>
              ...
              <Text style={styles.cardSubtitle}>
                Current Balance: <Text style={{ color: '#D97706', fontWeight: '700' }}>{profile.outstandingBalance || '₹250.00'}</Text> • Credit Limit: {profile.creditLimit || '₹2,000.00'}
              </Text>
            </View>

            <Pressable
              onPress={() => onShowToast && onShowToast(`Recording payment for ${profile.name}`)}
      ...
      {activeTab === 'info' && (
        <View style={styles.cardContainer}>
          <View style={styles.cardHeaderRow}>
            <View style={styles.cardTitleBox}>
              <Text style={styles.cardTitle}>Complete Customer Information</Text>
              <Text style={styles.cardSubtitle}>Demographics, prescriber information, and credit settings.</Text>
            </View>
          </View>

          <View style={styles.infoGridContainer}>
            <View style={styles.infoSection}>
              <Text style={styles.infoSectionHeading}>1. Contact & Demographics</Text>
              <View style={styles.infoGrid}>
                ...
                <View style={styles.infoItem}>
                  ...
                  <Text style={styles.infoValue}>{profile.age || 32} Yrs / {profile.gender || 'Female'}</Text>
                </View>
                <View style={styles.infoItemFull}>
                  <Text style={styles.infoLabel}>Billing & Shipping Address</Text>
                  <Text style={styles.infoValue}>{profile.address || 'B-404, Green Palms, Andheri West, Mumbai, MH - 400053'}</Text>
                </View>
              </View>
            </View>

            <View style={styles.infoSection}>
              <Text style={styles.infoSectionHeading}>2. Prescriber & Medical Reference (RX-02 & RX-03)</Text>
              <View style={styles.infoGrid}>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Attending Doctor</Text>
                  <Text style={styles.infoValue}>{profile.doctorName || 'Dr. Farooq Siddiqui'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Doctor Specialization</Text>
                  <Text style={styles.infoValue}>{profile.doctorSpecialization || 'General Physician'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Hospital / Clinic</Text>
                  <Text style={styles.infoValue}>{profile.hospitalClinic || 'Lifecare Clinic Mumbai'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Active Rx Ref No.</Text>
                  <Text style={[styles.infoValue, { color: '#0F766E', fontWeight: '700' }]}>{profile.activeRxNo || 'Rx-2026-1025'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Chronic Conditions</Text>
                  <Text style={styles.infoValue}>{profile.chronicConditions || 'None'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Reported Drug Allergies</Text>
                  <Text style={[styles.infoValue, { color: '#DC2626' }]}>{profile.allergies || 'Sulfa Drugs'}</Text>
                </View>
              </View>
            </View>

            <View style={styles.infoSection}>
              <Text style={styles.infoSectionHeading}>3. Account & Credit Terms</Text>
              <View style={styles.infoGrid}>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Customer Status</Text>
                  <Text style={[styles.infoValue, { color: '#16A34A', fontWeight: '700' }]}>{profile.status || 'Active'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Credit Facility</Text>
                  <Text style={styles.infoValue}>{profile.creditAllowed !== false ? 'Enabled' : 'Disabled'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Assigned Credit Limit</Text>
                  <Text style={[styles.infoValue, { fontWeight: '700' }]}>{profile.creditLimit || '₹2,000.00'}</Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Current Outstanding Dues</Text>
                  <Text style={[styles.infoValue, { color: '#D97706', fontWeight: '700' }]}>{profile.outstandingBalance || '₹250.00'}</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          >
            ...
            >
              <View style={styles.modalHeader}>
                <View>
                  <Text style={styles.modalTitle}>Invoice {selectedInvoice.invoiceNo}</Text>
                  <Text style={styles.modalSubtitle}>
                    {selectedInvoice.dateTime} • Paid via {selectedInvoice.paymentMethod}
                  </Text>
                </View>
                <Pressable
                  onPress={() => setInvoiceModalVisible(false)}
              ...
              <ScrollView style={styles.modalBody}>
                <Text style={styles.modalSectionTitle}>Dispensed Items & Prescriptions</Text>
                {selectedInvoice.itemsList && selectedInvoice.itemsList.length > 0 ? (
                  ...
                  <Text style={styles.modalItemQty}>No itemized detail available for older archive.</Text>
                )}

                <View style={styles.modalTotalRow}>
                  <Text style={styles.modalTotalLabel}>Total Amount</Text>
                  <Text style={styles.modalTotalValue}>{selectedInvoice.amount}</Text>
                </View>
              </ScrollView>
              ...
              <View style={styles.modalFooter}>
                <Pressable
                  onPress={() => {
                    ...
                    if (onShowToast) onShowToast(`Printing receipt for ${selectedInvoice.invoiceNo}`);
                  }}
