      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.tabBar}>
          <Pressable
            ...
            style={[
              styles.tabButton,
              activeTab === "low-stock" && styles.tabButtonActive,
            ]}
          >
            <Text
              style={[
          ...
          <Pressable
            ...
            style={[
              styles.tabButton,
              activeTab === "batch-timeline" && styles.tabButtonActive,
            ]}
          >
            <Text
              style={[
            ...
            >
              <View
                style={[
                  ...
                  criticalOnly && styles.filterToggleDotActive,
                ]}
              />
              <Text
                style={[
                  styles.filterToggleText,
                  criticalOnly && styles.filterToggleTextActive,
                ]}
              >
                  ...
                  <View key={item.id} style={styles.mobileStatusCard}>
                    <View style={styles.mobileStatusHeader}>
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.mobileGenericSubtitle}>
                    ...
                    <View style={styles.mobileActionFooter}>
                      ...
                      >
                        <Text style={styles.mobileActionDotsText}>
                          ⋮ Actions
                        </Text>
                      </Pressable>
                    </View>
                ...
                {paginatedItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text
                        style={[styles.tdCell, styles.skuCell, { width: 100 }]}
                      >
                        {item.sku}
                      </Text>
                      <Text
              ...
              <View>
                <Text style={styles.actionMenuTitle}>
                  {selectedItemForAction?.brandName ||
                    selectedItemForAction?.medicine}
                </Text>
            ...
            <View style={styles.actionList}>
                ...
                <View style={styles.actionOptionTextCol}>
                  ...
                  >
                    {actionItemType === "expiry"
                      ...
                      : "Quarantine / Damaged Loss"}
                  </Text>
                  <Text style={styles.actionOptionDesc}>
                    Deduct inventory with financial write-off loss reason
                  </Text>
                </View>
              </Pressable>
              ...
              >
                ...
                <View style={styles.actionOptionTextCol}>
                  ...
                  <Text style={styles.actionOptionDesc}>
                    Request surplus stock from nearby pharmacy branch
                  </Text>
                </View>
              </Pressable>
              ...
              >
                ...
                <View style={styles.actionOptionTextCol}>
                  ...
                  <Text style={styles.actionOptionDesc}>
                    Send priority replenishment notice to medical rep
                  </Text>
                </View>
              </Pressable>
            </View>
